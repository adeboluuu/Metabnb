...
function Body() {
  return (
    <div className='md:mx-10 mx-5 px-7 sm:grid sm:grid-cols-5 gap-3 block sm:py-20 py-5'>
        <div className='col-span-3'>
            <p className='lg:mb-8 mb-4 md:text-6xl md:leading-[6rem] text-3xl leading-tight py-3   break-normal'>Rent a <span className='text-[#A02279]'>Place</span> away from <span className='text-[#A02279]'>Home</span> in the <span className='text-[#A02279]'>Metaverse</span></p>
