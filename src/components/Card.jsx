...
function Card(props) {
  return (
    <div className=' lg:mx-10 mx-auto p-2.5 lg:flex-col block my-2 border-[#D7D7D7] rounded-2xl border-[1px] xl:w-12/12 md:w-2/5 w-3/5 xl:h-[370px] lg:h-[283px] md:[270px]'>
